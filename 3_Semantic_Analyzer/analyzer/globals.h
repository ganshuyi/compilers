...
typedef enum {IfK,IfElseK,WhileK,CompoundK,ReturnK} StmtKind;
typedef enum {AssignK,OpK,ConstK,IdK,ArrIdK,CallK} ExpKind;
typedef enum {VarK,FunK,ArrVarK} DeclKind;
typedef enum {ArrParamK,NonArrParamK,VoidParamK} ParamKind;
...
typedef struct treeNode
   { struct treeNode * child[MAXCHILDREN];
     ...
     int lineno;
     NodeKind nodekind;
     union { StmtKind stmt; ExpKind exp; 
